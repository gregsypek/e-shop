...
export const CartContextProvider = (props: Props) => {
	...
	console.log("🚀 ~ file: useCart.tsx:29 ~ CartContextProvider ~ cartTotalQty:", cartTotalQty)
	const [cartProducts, setCartProducts] = useState<CartProductType[] | null>(
		null
	);
	const [cartTotalAmount, setCartTotalAmount] = useState(0);
	console.log("🚀 ~ file: useCart.tsx:34 ~ CartContextProvider ~ cartTotalAmount:", cartTotalAmount)
